    ...
    dispatch(disputeOrder(
      {
          ...
          title,
          disputeType,
          buyerEvidence: orderDetails.order.rentedBy._id===userInfo._id?thumbnailImage:null,
          sellerEvidence:orderDetails.order.rentedFrom._id===userInfo._id?thumbnailImage:null,
          message: description,
          serviceType,
          disputeCreatedBy: userInfo._id,
          disputeCreatedAgainst: orderDetails.order.rentedBy._id===userInfo._id?orderDetails.order.rentedFrom._id: orderDetails.order.rentedBy._id
