import {
  ...
  export const communityServicePostsReducer = (state = { communityServicePosts: [] }, action) => {
    switch (action.type) {
  ...
  export const communityServicePostCreateReducer = (state = {}, action) => {
    switch (action.type) {
      ...
      case COMMUNITY_SERVICE_CREATE_SUCCESS:
        return { loading: false, success: true, communityServicePost: action.payload };
  ...
  export const communityServicePostUpdateReducer = (state = { communityServicePost: {} }, action) => {
    switch (action.type) {
